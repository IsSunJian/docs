import{_ as a,c as s,o as n,a4 as e}from"./chunks/framework.-JfgED0h.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/js/前端简洁并实用的工具类.md","filePath":"frontend/js/前端简洁并实用的工具类.md"}'),p={name:"frontend/js/前端简洁并实用的工具类.md"},l=e(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>本文主要从日期,数组,对象,axios,promise和字符判断这几个方面讲工作中常用的一些函数进行了封装,确实可以在项目中直接引用,提高开发效率.</p><h2 id="_1-日期" tabindex="-1">1.日期 <a class="header-anchor" href="#_1-日期" aria-label="Permalink to &quot;1.日期&quot;">​</a></h2><p>日期在后台管理系统还是用的很多的,一般是作为数据存贮和管理的一个维度,所以就会涉及到很多对日期的处理</p><h3 id="_1-1-new-date转化为yyyy-mm-dd-hh-mm-ss" tabindex="-1">1.1 new Date转化为yyyy-MM-dd HH:mm:ss <a class="header-anchor" href="#_1-1-new-date转化为yyyy-mm-dd-hh-mm-ss" aria-label="Permalink to &quot;1.1 new Date转化为yyyy-MM-dd HH:mm:ss&quot;">​</a></h3><p>DatePicker日期选择器默认获取到的日期默认是Date对象,但是我们后台需要用到的是yyyy-MM-dd,所以需要我们进行转化</p><p>方法一:将Fri Mar 23 2018 12:19:48 GMT+0800 (国际时间)转化为dd-MM-yyyy HH:mm:ss</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>export const dateToFormat=(date)=&gt;{</span></span>
