import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.-JfgED0h.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/js/269个JS工具函数.md","filePath":"frontend/js/269个JS工具函数.md"}'),e={name:"frontend/js/269个JS工具函数.md"},l=p(`<h2 id="_1-匹配正整数" tabindex="-1">1.匹配正整数 <a class="header-anchor" href="#_1-匹配正整数" aria-label="Permalink to &quot;1.匹配正整数&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>// 匹配正整数</span></span>
