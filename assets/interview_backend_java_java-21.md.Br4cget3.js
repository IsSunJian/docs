import{_ as a,c as n,o as s,a4 as e}from"./chunks/framework.-JfgED0h.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"interview/backend/java/java-21.md","filePath":"interview/backend/java/java-21.md"}'),p={name:"interview/backend/java/java-21.md"},l=e(`<h3 id="_1、string-属于基础的数据类型吗" tabindex="-1"><a href="https://gitee.com/souyunku/DevBooks/blob/master/docs/Java/Java%E6%9C%80%E6%96%B0%E5%9F%BA%E7%A1%80%E9%9D%A2%E8%AF%95%E9%A2%98%E5%8F%8A%E7%AD%94%E6%A1%88%E6%95%B4%E7%90%86.md#1string-%E5%B1%9E%E4%BA%8E%E5%9F%BA%E7%A1%80%E7%9A%84%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B%E5%90%97" target="_blank" rel="noreferrer">1、String 属于基础的数据类型吗？</a> <a class="header-anchor" href="#_1、string-属于基础的数据类型吗" aria-label="Permalink to &quot;[1、String 属于基础的数据类型吗？](https://gitee.com/souyunku/DevBooks/blob/master/docs/Java/Java最新基础面试题及答案整理.md#1string-属于基础的数据类型吗)&quot;">​</a></h3><p>String 不属于基础类型，基础类型有 8 种：byte、boolean、char、short、int、float、long、double，而 String 属于对象。</p><h3 id="_2、如何实现对象克隆" tabindex="-1"><a href="https://gitee.com/souyunku/DevBooks/blob/master/docs/Java/Java%E6%9C%80%E6%96%B0%E5%9F%BA%E7%A1%80%E9%9D%A2%E8%AF%95%E9%A2%98%E5%8F%8A%E7%AD%94%E6%A1%88%E6%95%B4%E7%90%86.md#2%E5%A6%82%E4%BD%95%E5%AE%9E%E7%8E%B0%E5%AF%B9%E8%B1%A1%E5%85%8B%E9%9A%86" target="_blank" rel="noreferrer">2、如何实现对象克隆？</a> <a class="header-anchor" href="#_2、如何实现对象克隆" aria-label="Permalink to &quot;[2、如何实现对象克隆？](https://gitee.com/souyunku/DevBooks/blob/master/docs/Java/Java最新基础面试题及答案整理.md#2如何实现对象克隆)&quot;">​</a></h3><p>有两种方式：</p><p>1)、实现Cloneable接口并重写Object类中的clone()方法；</p><p>2)、实现Serializable接口，通过对象的序列化和反序列化实现克隆，可以实现真正的深度克隆，代码如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>import java.io.ByteArrayInputStream;</span></span>
<span class="line"><span>import java.io.ByteArrayOutputStream;</span></span>
<span class="line"><span>import java.io.ObjectInputStream;</span></span>
<span class="line"><span>import java.io.ObjectOutputStream;</span></span>
<span class="line"><span>import java.io.Serializable;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>public class MyUtil {</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    private MyUtil() {</span></span>
<span class="line"><span>        throw new AssertionError();</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @SuppressWarnings(&quot;unchecked&quot;)</span></span>
<span class="line"><span>    public static &lt;T extends Serializable&gt; T clone(T obj) throws Exception {</span></span>
<span class="line"><span>        ByteArrayOutputStream bout = new ByteArrayOutputStream();</span></span>
<span class="line"><span>        ObjectOutputStream oos = new ObjectOutputStream(bout);</span></span>
<span class="line"><span>        oos.writeObject(obj);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        ByteArrayInputStream bin = new ByteArrayInputStream(bout.toByteArray());</span></span>
<span class="line"><span>        ObjectInputStream ois = new ObjectInputStream(bin);</span></span>
<span class="line"><span>        return (T) ois.readObject();</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        // 说明：调用ByteArrayInputStream或ByteArrayOutputStream对象的close方法没有任何意义</span></span>
<span class="line"><span>        // 这两个基于内存的流只要垃圾回收器清理对象就能够释放资源，这一点不同于对外部资源（如文件流）的释放</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>下面是测试代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>import java.io.Serializable;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>/</span></span>
<span class="line"><span> * 人类</span></span>
<span class="line"><span> * @author 骆昊</span></span>
<span class="line"><span> *</span></span>
<span class="line"><span> */</span></span>
<span class="line"><span>class Person implements Serializable {</span></span>
<span class="line"><span>    private static final long serialVersionUID = -9102017020286042305L;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    private String name;    // 姓名</span></span>
<span class="line"><span>    private int age;        // 年龄</span></span>
<span class="line"><span>    private Car car;        // 座驾</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    public Person(String name, int age, Car car) {</span></span>
<span class="line"><span>        this.name = name;</span></span>
<span class="line"><span>        this.age = age;</span></span>
<span class="line"><span>        this.car = car;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
