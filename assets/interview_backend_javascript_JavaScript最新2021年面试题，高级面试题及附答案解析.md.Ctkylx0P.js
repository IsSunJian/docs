import{_ as a,c as s,o as n,a4 as e}from"./chunks/framework.-JfgED0h.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"interview/backend/javascript/JavaScript最新2021年面试题，高级面试题及附答案解析.md","filePath":"interview/backend/javascript/JavaScript最新2021年面试题，高级面试题及附答案解析.md"}'),p={name:"interview/backend/javascript/JavaScript最新2021年面试题，高级面试题及附答案解析.md"},t=e(`<h3 id="_1、强制转换-显式转换-隐式转换" tabindex="-1"><a href="https://gitee.com/souyunku/DevBooks/blob/master/docs/JavaScript/JavaScript%E6%9C%80%E6%96%B02021%E5%B9%B4%E9%9D%A2%E8%AF%95%E9%A2%98%EF%BC%8C%E9%AB%98%E7%BA%A7%E9%9D%A2%E8%AF%95%E9%A2%98%E5%8F%8A%E9%99%84%E7%AD%94%E6%A1%88%E8%A7%A3%E6%9E%90.md#1%E5%BC%BA%E5%88%B6%E8%BD%AC%E6%8D%A2-%E6%98%BE%E5%BC%8F%E8%BD%AC%E6%8D%A2-%E9%9A%90%E5%BC%8F%E8%BD%AC%E6%8D%A2" target="_blank" rel="noreferrer">1、强制转换 显式转换 隐式转换?</a> <a class="header-anchor" href="#_1、强制转换-显式转换-隐式转换" aria-label="Permalink to &quot;[1、强制转换 显式转换 隐式转换?](https://gitee.com/souyunku/DevBooks/blob/master/docs/JavaScript/JavaScript最新2021年面试题，高级面试题及附答案解析.md#1强制转换-显式转换-隐式转换)&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>//强制类型转换：</span></span>
<span class="line"><span>Boolean(0)   // =false - 零</span></span>
<span class="line"><span>Boolean(new object())   // =true - 对象</span></span>
<span class="line"><span>Number(undefined)       // =  NaN</span></span>
<span class="line"><span>Number(null)              // =0</span></span>
<span class="line"><span>String(null)              // =&quot;null&quot;</span></span>
...
<span class="line"><span>   callback();</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>};</span></span></code></pre></div><p>第二种方式是使用箭头函数</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>const myFavoriteObj = {</span></span>
<span class="line"><span>  guessThis(){</span></span>
<span class="line"><span>     const getName = () =&gt; { </span></span>
<span class="line"><span>       console.log(this.name);</span></span>
<span class="line"><span>     }</span></span>
<span class="line"><span>     getName();</span></span>
<span class="line"><span>  },</span></span>
...
<span class="line"><span> }</span></span>
<span class="line"><span></span></span>
<span class="line"><span> Person.self = function(){</span></span>
<span class="line"><span>   return this;</span></span>
<span class="line"><span> }</span></span>
<span class="line"><span></span></span>
<span class="line"><span> Person.prototype.toString = function(){</span></span>
<span class="line"><span>   return &quot;[object Person]&quot;;</span></span>
<span class="line"><span> }</span></span>
<span class="line"><span></span></span>
<span class="line"><span> Person.prototype.getFullName = function (){</span></span>
<span class="line"><span>   return this.firstName + &quot; &quot; + this.lastName;</span></span>
<span class="line"><span> }  </span></span>
<span class="line"><span></span></span>
<span class="line"><span> //ES6 Version</span></span>
<span class="line"><span> class Person {</span></span>
<span class="line"><span>    constructor(firstName, lastName, age, address){</span></span>
<span class="line"><span>        this.lastName = lastName;</span></span>
<span class="line"><span>        this.firstName = firstName;</span></span>
<span class="line"><span>        this.age = age;</span></span>
<span class="line"><span>        this.address = address;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    static self() {</span></span>
<span class="line"><span>       return this;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    getFullName(){</span></span>
<span class="line"><span>       return \`\${this.firstName} \${this.lastName}\`;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span> }</span></span></code></pre></div><p>重写方法并从另一个类继承。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>//ES5 Version</span></span>
<span class="line"><span>Employee.prototype = Object.create(Person.prototype);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>function Employee(firstName, lastName, age, address, jobTitle, yearStarted) {</span></span>
<span class="line"><span>  Person.call(this, firstName, lastName, age, address);</span></span>
<span class="line"><span>  this.jobTitle = jobTitle;</span></span>
<span class="line"><span>  this.yearStarted = yearStarted;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Employee.prototype.describe = function () {</span></span>
<span class="line"><span>  return \`I am \${this.getFullName()} and I have a position of \${this.jobTitle} and I started at \${this.yearStarted}\`;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Employee.prototype.toString = function () {</span></span>
<span class="line"><span>  return &quot;[object Employee]&quot;;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>//ES6 Version</span></span>
<span class="line"><span>class Employee extends Person { //Inherits from &quot;Person&quot; class</span></span>
<span class="line"><span>  constructor(firstName, lastName, age, address, jobTitle, yearStarted) {</span></span>
<span class="line"><span>    super(firstName, lastName, age, address);</span></span>
<span class="line"><span>    this.jobTitle = jobTitle;</span></span>
<span class="line"><span>    this.yearStarted = yearStarted;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
