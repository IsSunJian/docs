import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.-JfgED0h.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/js/实用工具.md","filePath":"frontend/js/实用工具.md"}'),l={name:"frontend/js/实用工具.md"},e=p(`<h2 id="原型链继承" tabindex="-1">原型链继承 <a class="header-anchor" href="#原型链继承" aria-label="Permalink to &quot;原型链继承&quot;">​</a></h2><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>// 将子类的原型对象 设置为 父类的实例对象  父类的原型对象</span></span>
