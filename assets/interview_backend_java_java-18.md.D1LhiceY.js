...
<span class="line"><span>        System.out.println(&quot;保存数据方法&quot;);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>下面是代理类，可重复使用，不像静态代理那样要自己重复编写代理</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>package com.lijie;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// 每次生成动态代理类对象时,实现了InvocationHandler接口的调用处理器对象</span></span>
<span class="line"><span>public class InvocationHandlerImpl implements InvocationHandler {</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    // 这其实业务实现类对象，用来调用具体的业务方法</span></span>
<span class="line"><span>    private Object target;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    // 通过构造函数传入目标对象</span></span>
<span class="line"><span>    public InvocationHandlerImpl(Object target) {</span></span>
<span class="line"><span>        this.target = target;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    //动态代理实际运行的代理方法</span></span>
<span class="line"><span>    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {</span></span>
<span class="line"><span>        System.out.println(&quot;调用开始处理&quot;);</span></span>
<span class="line"><span>        //下面invoke()方法是以反射的方式来创建对象，第一个参数是要创建的对象，第二个是构成方法的参数，由第二个参数来决定创建对象使用哪个构造方法</span></span>
<span class="line"><span>        Object result = method.invoke(target, args);</span></span>
<span class="line"><span>        System.out.println(&quot;调用结束处理&quot;);</span></span>
<span class="line"><span>        return result;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>利用动态代理使用代理方法</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>package com.lijie;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import java.lang.reflect.Proxy;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>public class Test {</span></span>
<span class="line"><span>    public static void main(String[] args) {</span></span>
<span class="line"><span>        // 被代理对象</span></span>
<span class="line"><span>        UserDao userDaoImpl = new UserDaoImpl();</span></span>
<span class="line"><span>        InvocationHandlerImpl invocationHandlerImpl = new InvocationHandlerImpl(userDaoImpl);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        //类加载器</span></span>
<span class="line"><span>        ClassLoader loader = userDaoImpl.getClass().getClassLoader();</span></span>
<span class="line"><span>        Class&lt;?&gt;[] interfaces = userDaoImpl.getClass().getInterfaces();</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        // 主要装载器、一组接口及调用处理动态代理实例</span></span>
<span class="line"><span>        UserDao newProxyInstance = (UserDao) Proxy.newProxyInstance(loader, interfaces, invocationHandlerImpl);</span></span>
<span class="line"><span>        newProxyInstance.save();</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><strong>缺点：</strong></p><p>必须是面向接口，目标业务类必须实现接口</p><p><strong>优点：</strong></p><p>不用关心代理类，只需要在运行阶段才指定代理哪一个对象</p><ul><li>CGLIB动态代理</li></ul><p><strong>CGLIB动态代理原理：</strong></p><p>利用asm开源包，对代理对象类的class文件加载进来，通过修改其字节码生成子类来处理。</p><p><strong>什么是CGLIB动态代理</strong></p><p>CGLIB动态代理和jdk代理一样，使用反射完成代理，不同的是他可以直接代理类（jdk动态代理不行，他必须目标业务类必须实现接口），CGLIB动态代理底层使用字节码技术，CGLIB动态代理不能对 final类进行继承。（CGLIB动态代理需要导入jar包）</p><ul><li>代码演示</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>package com.lijie;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>//接口</span></span>
<span class="line"><span>public interface UserDao {</span></span>
<span class="line"><span>    void save();</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>package com.lijie;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import org.springframework.cglib.proxy.Enhancer;</span></span>
<span class="line"><span>import org.springframework.cglib.proxy.MethodInterceptor;</span></span>
<span class="line"><span>import org.springframework.cglib.proxy.MethodProxy;</span></span>
<span class="line"><span>import java.lang.reflect.Method;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>//代理主要类</span></span>
<span class="line"><span>public class CglibProxy implements MethodInterceptor {</span></span>
<span class="line"><span>    private Object targetObject;</span></span>
<span class="line"><span>    // 这里的目标类型为Object，则可以接受任意一种参数作为被代理类，实现了动态代理</span></span>
<span class="line"><span>    public Object getInstance(Object target) {</span></span>
<span class="line"><span>        // 设置需要创建子类的类</span></span>
<span class="line"><span>        this.targetObject = target;</span></span>
<span class="line"><span>        Enhancer enhancer = new Enhancer();</span></span>
<span class="line"><span>        enhancer.setSuperclass(target.getClass());</span></span>
<span class="line"><span>        enhancer.setCallback(this);</span></span>
<span class="line"><span>        return enhancer.create();</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    //代理实际方法</span></span>
