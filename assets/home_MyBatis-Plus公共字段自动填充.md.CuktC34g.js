import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.-JfgED0h.js";const e="/docs/assets/image-20220725172038979.Db7ex_OP.png",h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"home/MyBatis-Plus公共字段自动填充.md","filePath":"home/MyBatis-Plus公共字段自动填充.md"}'),l={name:"home/MyBatis-Plus公共字段自动填充.md"},t=p('<h2 id="_1-问题分析" tabindex="-1">1.问题分析 <a class="header-anchor" href="#_1-问题分析" aria-label="Permalink to &quot;1.问题分析&quot;">​</a></h2><blockquote><p>我们在开发中经常遇到多个实体类有共同的属性字段，例如在新增员工时需要设置创建时间、创建人、修改时间、修改人等字段，在编辑员工时需要设置修改时间和修改人等字段。这些字段属于公共字段，也就是很多表中都有这些字段，能不能对于这些公共字段在某个地方统一处理，来简化开发呢？</p></blockquote><p><img src="'+e+`" alt="image-20220725172038979"></p><p>答案就是使用<code>Mybatis Plus</code>提供的<strong>公共字段自动填充功能</strong>。</p><h2 id="_2-实现步骤" tabindex="-1">2.实现步骤 <a class="header-anchor" href="#_2-实现步骤" aria-label="Permalink to &quot;2.实现步骤&quot;">​</a></h2><blockquote><p>Mybatis Plus公共字段自动填充，也就是在插入或者更新的时候为指定字段赋予指定的值，使用它的好处就是可以统一对这些字段进行处理，避免了重复代码。</p></blockquote><p><strong>实现步骤：</strong></p><ul><li><p>在实体类的属性上加入<code>@TableField</code>注解，指定自动填充的策略</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>@TableField(fill = FieldFill.INSERT)//插入时填充字段</span></span>
