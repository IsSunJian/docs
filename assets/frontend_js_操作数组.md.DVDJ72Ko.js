import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.K9vKjHgL.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/js/操作数组.md","filePath":"frontend/js/操作数组.md"}'),e={name:"frontend/js/操作数组.md"},l=p(`<h2 id="基础用法-只写参数必选值的用法" tabindex="-1">基础用法 只写参数必选值的用法 <a class="header-anchor" href="#基础用法-只写参数必选值的用法" aria-label="Permalink to &quot;基础用法 只写参数必选值的用法&quot;">​</a></h2><h2 id="数组去重方法" tabindex="-1">数组去重方法： <a class="header-anchor" href="#数组去重方法" aria-label="Permalink to &quot;数组去重方法：&quot;">​</a></h2><p><strong>sort 排序</strong></p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light dracula-soft vp-code"><code><span class="line"><span>const arr = [1, 2, 3, 4, 5, 6, 4, 3, 7, 1]</span></span>
